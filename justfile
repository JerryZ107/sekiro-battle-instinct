install *args:
    ...
    cp "./target/debug/version.dll" "C:/Program Files (x86)/Steam/steamapps/common/Sekiro/version.dll"
logs:
...
pack:
    ...
    cp "./target/release/version.dll" "./tmp/version.dll"

    cp -f "./res/battle_instinct.cfg" "./tmp/battle_instinct.cfg"
    7z a -tzip -mx9 "./battle-instinct.zip" "./tmp/dinput8.dll" "./tmp/version.dll" "./tmp/battle_instinct.cfg"

    cp -f "./res/battle_instinct_zh.cfg" "./tmp/battle_instinct.cfg"
    7z a -tzip -mx9 "./battle-instinct_zh.zip" "./tmp/dinput8.dll" "./tmp/version.dll" "./tmp/battle_instinct.cfg"
